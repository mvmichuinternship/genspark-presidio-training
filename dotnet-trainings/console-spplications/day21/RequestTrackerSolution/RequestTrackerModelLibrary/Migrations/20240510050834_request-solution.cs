        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SolName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SolDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RequestSolutions", x => x.SolId);
                    table.ForeignKey(
