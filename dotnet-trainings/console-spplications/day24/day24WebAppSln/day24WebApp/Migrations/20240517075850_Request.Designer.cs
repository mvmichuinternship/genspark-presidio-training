...
namespace day24WebApp.Migrations
{
    ...
    [Migration("20240517075850_Request")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("day24WebApp.models.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("day24WebApp.models.Request", b =>
                {
            ...
            modelBuilder.Entity("day24WebApp.models.Request", b =>
                {
                    b.HasOne("day24WebApp.models.Employee", "RequestClosedByEmployee")
                        .WithMany("RequestsClosed")
                        .HasForeignKey("RequestClosedBy")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("day24WebApp.models.Employee", "RaisedByEmployee")
